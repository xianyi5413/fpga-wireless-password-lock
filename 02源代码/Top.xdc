...
##Switches
set_property -dict {PACKAGE_PIN J15 IOSTANDARD LVCMOS33} [get_ports SW0_IN]
set_property -dict {PACKAGE_PIN L16 IOSTANDARD LVCMOS33} [get_ports SW1_IN]
set_property -dict {PACKAGE_PIN M13 IOSTANDARD LVCMOS33} [get_ports SW2_IN]
set_property -dict {PACKAGE_PIN R15 IOSTANDARD LVCMOS33} [get_ports SW3_IN]
set_property -dict {PACKAGE_PIN R17 IOSTANDARD LVCMOS33} [get_ports SW4_IN]
set_property -dict {PACKAGE_PIN T18 IOSTANDARD LVCMOS33} [get_ports SW5_IN]
set_property -dict {PACKAGE_PIN U18 IOSTANDARD LVCMOS33} [get_ports SW6_IN]
set_property -dict {PACKAGE_PIN R13 IOSTANDARD LVCMOS33} [get_ports SW7_IN]
set_property -dict {PACKAGE_PIN T8 IOSTANDARD LVCMOS33} [get_ports SW8_IN]
set_property -dict {PACKAGE_PIN U8 IOSTANDARD LVCMOS33} [get_ports SW9_IN]
...
set_property -dict {PACKAGE_PIN V14 IOSTANDARD LVCMOS33} [get_ports {STATE[0]}]
set_property -dict {PACKAGE_PIN V12 IOSTANDARD LVCMOS33} [get_ports {STATE[1]}]
set_property -dict {PACKAGE_PIN V11 IOSTANDARD LVCMOS33} [get_ports {STATE[2]}]
...
set_property -dict {PACKAGE_PIN M18 IOSTANDARD LVCMOS33} [get_ports BACKSPACE_IN]
set_property -dict {PACKAGE_PIN P17 IOSTANDARD LVCMOS33} [get_ports START_IN]
set_property -dict {PACKAGE_PIN M17 IOSTANDARD LVCMOS33} [get_ports OK_IN]
set_property -dict {PACKAGE_PIN P18 IOSTANDARD LVCMOS33} [get_ports MANAGER_IN]
...
set_property PACKAGE_PIN H14 [get_ports BT_RX]
set_property PACKAGE_PIN G16 [get_ports BT_TX]
set_property IOSTANDARD LVCMOS33 [get_ports BT_RX]
set_property IOSTANDARD LVCMOS33 [get_ports BT_TX]

set_property IOSTANDARD LVCMOS33 [get_ports BT_ACTIVE]
set_property PACKAGE_PIN D10 [get_ports BT_ACTIVE]
